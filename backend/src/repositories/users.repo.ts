...
import { findByIdOrThrow, updateById, PaginationOptions, PaginatedResult } from './base.repo';
import type { User, PatreonMembership } from '@surge/shared';
...
export async function findUserWithMembership(id: string): Promise<{ user: User; membership: PatreonMembership | null }> {
