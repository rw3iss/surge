    ...
    <div class="rich-text-editor">
      <div class="rte-toolbar">
        <div class="rte-toolbar__group">
          <select onChange={(e) => { formatBlock(e.currentTarget.value); e.currentTarget.value = ''; }}>
        ...
        <div class="rte-toolbar__group">
          <button type="button" onClick={() => execCommand('bold')} title="Bold (Ctrl+B)"><b>B</b></button>
          <button type="button" onClick={() => execCommand('italic')} title="Italic (Ctrl+I)"><i>I</i></button>
          <button type="button" onClick={() => execCommand('underline')} title="Underline (Ctrl+U)"><u>U</u></button>
        ...
        <div class="rte-toolbar__group">
          <button type="button" onClick={() => setShowLinkDialog(!showLinkDialog())} title="Insert Link">Link</button>
