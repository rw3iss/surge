      ...
      <Show when={props.mode === 'edit'} fallback={
        ...
        <div class="form-group">
          ...
          <Show when={props.data.fileName}>
            <span class="form-help">{props.data.fileName} ({Math.round((props.data.fileSize || 0) / 1024 / 1024 * 10) / 10} MB)</span>
          </Show>
        </div>
        <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            <label class="checkbox-label">
              <input type="checkbox" checked={props.data.autoplay || false} onChange={(e) => props.onUpdate({ ...props.data, autoplay: e.currentTarget.checked })} />
              Autoplay
            </label>
          </div>
          <div class="form-group">
            <label class="checkbox-label">
              <input type="checkbox" checked={props.data.loop || false} onChange={(e) => props.onUpdate({ ...props.data, loop: e.currentTarget.checked })} />
              Loop
            </label>
          </div>
        </div>
