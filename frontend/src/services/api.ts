...
export const fetchNavigation = () =>
  api.get('/pages/navigation');

export const fetchSettings = () =>
  api.get('/settings/public');

export const fetchCampaigns = (includePast = false) =>
  api.get(`/campaigns/public?includePast=${includePast}`);

export const fetchCampaign = (slug: string) =>
  api.get(`/campaigns/slug/${slug}`);

export const fetchForm = (slug: string) =>
  api.get(`/forms/slug/${slug}`);
