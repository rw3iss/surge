                ...
                <A href={`/campaigns/${campaign.slug}`} class="donate-page__card">
                  ...
                  <div class="donate-page__card-content">
                    ...
                    <div class="donate-page__progress">
                      <div class="donate-page__progress-bar" style={{ width: `${Math.min((campaign.currentAmountCents / campaign.goalAmountCents) * 100, 100)}%` }} />
                    </div>
                    <span>${(campaign.currentAmountCents / 100).toLocaleString()} raised of ${(campaign.goalAmountCents / 100).toLocaleString()}</span>
                  </div>
                </A>
              )}
            </For>
        ...
        <section class="donate-page__section">
          ...
          <div class="donate-page__grid">
            <For each={pastCampaigns()}>
              {(campaign) => (
                <A href={`/campaigns/${campaign.slug}`} class="donate-page__card donate-page__card--past">
                  <h3>{campaign.title}</h3>
                  <span>Completed - ${(campaign.currentAmountCents / 100).toLocaleString()} raised</span>
                </A>
              )}
            </For>
          </div>
