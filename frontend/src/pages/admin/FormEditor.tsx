                        ...
                        <div class="form-group">
                          ...
                          <select
                            ...
                            onChange={(e) => updateQuestion(index(), {
                              type: (e.target as HTMLSelectElement).value as FormQuestion['type'],
                              options: isPollType((e.target as HTMLSelectElement).value) && question.options.length === 0
                                ? ['', '']
                                : question.options
                            })}
                          >
