      ...
      <div class="admin-layout">
        ...
        <aside class={`admin-layout__sidebar ${sidebarOpen() ? 'admin-layout__sidebar--open' : ''}`}>
          ...
          <nav class="admin-layout__nav">
            ...
            <A href="/admin/forms" class={`admin-layout__nav-link ${isActive('/admin/forms') ? 'active' : ''}`} onClick={handleNavClick}>Forms</A>
            <A href="/admin/users" class={`admin-layout__nav-link ${isActive('/admin/users') ? 'active' : ''}`} onClick={handleNavClick}>Users</A>
            <A href="/admin/messages" class={`admin-layout__nav-link ${isActive('/admin/messages') ? 'active' : ''}`} onClick={handleNavClick}>Messages</A>
            <A href="/admin/media" class={`admin-layout__nav-link ${isActive('/admin/media') ? 'active' : ''}`} onClick={handleNavClick}>Media</A>
            <A href="/admin/settings" class={`admin-layout__nav-link ${isActive('/admin/settings') ? 'active' : ''}`} onClick={handleNavClick}>Settings</A>
          </nav>
