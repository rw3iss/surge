    ...
    <div class="admin-forms">
      ...
      <div class="admin-table-container">
        <table class="admin-table">
          ...
          <tbody>
            <Show when={!forms.loading} fallback={<tr><td colspan="5">Loading...</td></tr>}>
              <For each={forms()} fallback={<tr><td colspan="5">No forms found</td></tr>}>
                {(form: any) => (
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      <Show when={form.submissionCount > 0}>
                        <A href={`/admin/forms/${form.id}/submissions`} class="btn btn--small btn--secondary">
                          View Responses
                        </A>
                      </Show>
                    </td>
