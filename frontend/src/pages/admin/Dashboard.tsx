          ...
          <>
            ...
            <div class="dashboard-stats">
              ...
              <A href="/admin/campaigns" class="stat-card stat-card--wide">
                ...
                <div class="stat-card__content">
                  <span class="stat-card__value">{formatCurrency(data().campaigns.totalRaisedCents)}</span>
                  <span class="stat-card__label">Total Raised ({data().campaigns.active} active campaigns, {data().campaigns.totalDonors} donors)</span>
                </div>
              </A>
            ...
            <div class="dashboard-panels">
              <div class="dashboard-panel">
                ...
                <div class="dashboard-panel__body">
                  <Show when={data().recentPosts?.length} fallback={<p class="text-muted">No posts yet.</p>}>
                        ...
                        <A href={`/admin/posts/${post.id}`} class="dashboard-activity-item">
                          <div class="dashboard-activity-item__content">
                            ...
                            <span class="dashboard-activity-item__meta">
                              <span class={`badge badge--small ${post.status === 'published' ? 'badge--success' : 'badge--warning'}`}>{post.status}</span>
                ...
                <div class="dashboard-panel__body">
                  <div class="dashboard-summary-list">
                    <div class="dashboard-summary-item">
                      ...
                      <span class="dashboard-summary-item__value">{data().donations.last30Days.count}</span>
                    </div>
                    <div class="dashboard-summary-item">
                      <span class="dashboard-summary-item__label">Donation revenue</span>
                      <span class="dashboard-summary-item__value">{formatCurrency(data().donations.last30Days.totalCents)}</span>
                    </div>
                    <div class="dashboard-summary-item">
                      <span class="dashboard-summary-item__label">Form submissions</span>
                      <span class="dashboard-summary-item__value">{data().forms.submissionsLast30Days}</span>
                    </div>
                  </div>
                </div>
              </div>
