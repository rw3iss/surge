        ...
        <Show when={!success()} fallback={
          ...
          <div class="join__section">
            ...
            <p class="join__section-desc">
              Link your Patreon account to get full access to all media, exclusive posts,
              and subscriber-only benefits. Supporting through Patreon helps us create more content.
            </p>
            <button
              type="button"
          ...
          <div class="join__section">
            ...
            <p class="join__section-desc">
              Create a standard account to browse public content. Note that free accounts
              have limited access — only public posts and media will be visible.
            </p>

            <div class="join__notice">
              <svg class="join__notice-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <circle cx="12" cy="12" r="10" />
                <line x1="12" y1="16" x2="12" y2="12" />
                <line x1="12" y1="8" x2="12.01" y2="8" />
              </svg>
              <span>Free accounts only see limited posts and data. Subscribe through Patreon for full access to all media and extra benefits.</span>
            </div>
