        ...
        <div class="contact__card">
          <Show when={status() === 'success'}>
            <div class="contact__success">
              <svg class="contact__success-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <form class="contact__form" onSubmit={handleSubmit}>
              <Show when={status() === 'error'}>
                <div class="contact__error">
                  <svg class="contact__error-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
